    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center px-6 py-12">
      ...
      <LessonHero
        ...
        title={
          <>
            🌍 Build a{" "}
            <span className="text-green-400">Diversified Portfolio</span>
          </>
        }
        subtitle="Master the Art of Global Diversification with Four Core Holdings"
        description="ITOT • VXUS • AGG • BNDX — Your foundation for long-term wealth"
      />

      {/* Why Diversification Matters */}
      <LessonSection
        title="🎯 Why Diversification is Your Best Friend"
      ...
      >
        ...
        <Card className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border-blue-700 p-6">
          ...
          <p className="text-center text-gray-300">
            ...
            return in modern history, while individual stocks and sectors can go
            to zero.
          </p>
        </Card>
      </LessonSection>
      ...
      <LessonSection
        title="🏗️ The Four-Fund Foundation"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-blue-900/20 border-blue-700 p-6 hover:bg-blue-900/30 transition-all">
            ...
            <div className="space-y-3 text-gray-300 text-sm">
              ...
              <p>
                <strong>Why this fund:</strong> Broadest US coverage, ultra-low
                0.03% fee
              </p>
              <p>
          ...
          <Card className="bg-green-900/20 border-green-700 p-6 hover:bg-green-900/30 transition-all">
            ...
            <div className="space-y-3 text-gray-300 text-sm">
              <p>
                <strong>What it holds:</strong> 7,000+ non-US companies (Nestlé,
                Samsung, TSMC)
              </p>
              <p>
          ...
          <Card className="bg-yellow-900/20 border-yellow-700 p-6 hover:bg-yellow-900/30 transition-all">
            ...
            <div className="space-y-3 text-gray-300 text-sm">
              ...
              <p>
                <strong>Why this fund:</strong> Broad bond exposure, 0.03% fee,
                high quality
              </p>
              <p>
          ...
          <Card className="bg-purple-900/20 border-purple-700 p-6 hover:bg-purple-900/30 transition-all">
            ...
            <div className="space-y-3 text-gray-300 text-sm">
              <p>
                <strong>What it holds:</strong> Government bonds from developed
                countries
              </p>
              <p>
                <strong>Why this fund:</strong> Currency diversification, 0.07%
                fee
              </p>
              <p>
      ...
      <LessonSection
        title="🎨 Alternative Portfolio Approaches"
      ...
      >
        <KeyTakeaways
          ...
          items={[
            ...
            "Four funds (ITOT, VXUS, AGG, BNDX) provide global exposure",
            "Keep costs low - under 0.06% annually for the entire portfolio",
            "Automate everything to remove emotion from investing",
            "Rebalance annually to maintain target allocation",
            "Time in the market beats timing the market",
            "Start with whatever you can afford - consistency matters most",
          ]}
        />
      </LessonSection>
      ...
      <NextStepsCard
        ...
        description={
          "Congratulations! You now have a complete understanding of how to build a diversified portfolio. The next step is to take action - open a brokerage account and start investing with your four-fund foundation."
        }
        progressValue={100}
        lessonLabel={`Lesson 4 of 4 — ${
          state.lessonProgress === 100
            ? "Complete! You've mastered portfolio building."
            : "Keep exploring to complete this lesson."
        }`}
        completeMessage={
          state.lessonProgress === 100
            ? "Remember: The best portfolio is the one you can stick with. Start simple, stay consistent, and let time and compound interest work their magic."
            : undefined
        }
      />
    </div>
