  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center px-6 py-12">
      ...
      <NextStepsCard
        ...
        description={
          "Now that you have a clear financial independence plan, our next lesson will teach you the fundamentals of investing. You&lsquo;ll learn how to build the investment portfolio that will power your journey to FI."
        }
        progressValue={50}
        ...
        completeMessage={
          state.lessonProgress === 100
            ? "Remember: Financial independence isn&lsquo;t about having millions—it&lsquo;s about having enough to choose how you spend your time."
            : undefined
        }
      />
    </div>
