  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center px-4 py-8 md:px-6 md:py-12">
      ...
      <NextStepsCard
        ...
        description={
          "Now that you understand WHY you need to invest, our next lesson will teach you HOW to set clear, achievable financial goals. Because without a target, you&lsquo;re just throwing darts in the dark."
        }
        progressValue={25}
        ...
        completeMessage={
          state.lessonProgress === 100
            ? "Remember: Every expert was once a beginner. The difference between those who build wealth and those who don&lsquo;t isn&lsquo;t intelligence or income – it&lsquo;s taking action."
            : undefined
        }
      />
    </div>
